<!-- Modal -->
<div class="modal fade" id="deleteInvitationModal-{{$invitation->id}}" tabindex="-1" aria-labelledby="deleteInvitationLabel" aria-hidden="true">
        ...
        <div class="modal-content" style="overflow-y: auto;">
            ...
            <div class="modal-footer d-flex justify-content-center">
                <a type="button" class="btn btn-primary"
                        href="{{ route('admin.visitors.delete', ['id' => $invitation->id]) }}">نعم</a>
