...
@section('content')
    ...
    <div class="container pb-5">
        <div class="form-container mx-auto" style="max-width: 700px;">
            ...
            <!-- Form -->
            <form id="invitationForm" action="{{ route('form.student') }}" method="POST" novalidate>
                @csrf
                ...
                <div class="form-group mb-3">
                    <div class="input-group has-validation">
                        <div class="form-floating">
                            <input type="tel" id="phone_number" name="phone_number" value="{{ old('phone_number') }}" placeholder="رقم هاتف الشخص المسؤول *" class="form-control phone_input" required>
                        </div>
                ...
                <div class="form-group mb-3">
                    <div class="input-group has-validation">
                        ...
                        <div class="form-floating">
                            ...
                            <label for="university_specialization">اسم الفسم/الكلية/البرنامج  <span class="mandatory">*</span></label>
                        </div>
                    </div>
                    <div>
                ...
                <div class="form-group mb-3">
                    <div class="input-group has-validation">
                        <span class="input-group-text"><i class="fas fa-book"></i></span>
                        <div class="form-floating">
                            <input type="text" id="team_leader" name="team_leader" value="{{ old('team_leader') }}" class="form-control" placeholder="التخصص الجامعي">
