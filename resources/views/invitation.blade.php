            ...
            <form id="invitationForm" action="{{ route('visitor-invitation-submit') }}" method="POST" novalidate>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        <div class="input-group has-validation">
                            ...
                            <div class="form-floating">
                                <input type="text" id="first_name" name="first_name" value="{{ old('first_name') }}" class="form-control" placeholder="الاسم الأول" required>
                    ...
                    <div class="col-md-4">
                        <div class="input-group has-validation">
                            <span class="input-group-text"><i class="fas fa-user"></i></span>
                            <div class="form-floating">
                                <input type="text" id="second_name" name="second_name" value="{{ old('second_name') }}" class="form-control" placeholder="الاسم الثاني" required>
                    ...
                    <div class="col-md-4">
                        <div class="input-group has-validation">
                            <span class="input-group-text"><i class="fas fa-user"></i></span>
                            <div class="form-floating">
                                <input type="text" id="surname" name="sur_name" value="{{ old('sur_name') }}" class="form-control" placeholder="اسم العائلة" required>
                ...
                <div class="form-group mb-3">
                    <div class="input-group has-validation">
                        ...
                        <div class="form-floating">
                            <input type="text" id="national_id" maxlength="10" minlength="10" name="national_id" value="{{ old('national_id') }}" class="form-control" placeholder="رقم الهوية الوطنية" required>
                ...
                <div class="form-group mb-3">
                    <div class="input-group has-validation">
                        <div class="form-floating">
                            <input type="tel" id="phone_number" name="phone_number" value="{{ old('phone_number') }}" placeholder="رقم الهاتف *" class="form-control phone_input" required>
                        </div>
...
{{--                </div>--}}
                ...
                <div class="form-group mb-3">
                    <div class="input-group has-validation">
                        ...
                        <div class="form-floating">
                            <input type="text" id="university_name" name="university_name" value="{{ old('university_name') }}" class="form-control" placeholder="اسم الجامعة">
                ...
                <div class="form-group mb-3">
                    <div class="input-group has-validation">
                        ...
                        <div class="form-floating">
                            <input type="text" id="university_specialization" name="university_specialization" value="{{ old('university_specialization') }}" class="form-control" placeholder="التخصص الجامعي">
                ...
                <div class="form-group mb-3">
                    <div class="input-group has-validation">
                        ...
                        <div class="form-floating">
                            <input type="text" id="graduation_date" name="graduation_date" value="{{ old('graduation_date') }}" class="form-control month-year-picker" placeholder="اختر التاريخ" required>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input heard_about" id="social_media" value="وسائل التواصل الاجتماعي" name="heard_about[]">
                        <label class="form-check-label" for="social_media">وسائل التواصل الاجتماعي</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input heard_about" id="email_ads" value="البريد الإلكتروني" name="heard_about[]">
                        <label class="form-check-label" for="email_ads">البريد الإلكتروني</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input heard_about" id="friends" value="الأصدقاء" name="heard_about[]">
                    ...
                    <div id="heardOtherInputContainer" class="mt-2" style="display: none;">
                        <input type="text" id="heardOtherInput" name="heard_about[]" class="form-control" placeholder="أخرى">
                    </div>
                </div>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input reason_participation" id="academic_test" value="الاهتمام الأكاديمي" name="reason_participation[]">
                        <label class="form-check-label" for="academic_test">الاهتمام الأكاديمي</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input reason_participation" id="personal_interest" value="الاهتمام الشخصي بالمناظرات" name="reason_participation[]">
                        <label class="form-check-label" for="personal_interest">الاهتمام الشخصي بالمناظرات</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input reason_participation" id="networking" value="فرصة للتواصل وبناء علاقات" name="reason_participation[]">
                        <label class="form-check-label" for="networking">فرصة للتواصل وبناء علاقات</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input reason_participation" id="networking" value="متطلبات الفريق/الجامع" name="reason_participation[]">
                    ...
                    <div id="reasonOtherInputContainer" class="mt-2" style="display: none;">
                        <input type="text" id="reasonOtherInput" name="reason_participation[]" class="form-control" placeholder="اخرى">
                    </div>
                </div>
