...
<div style="text-align: right; font-size: 1rem !important;">
    <p>للاطلاع على الارشادات اضغط هنا</p>
    <a target="_blank" href="{{ asset('pdf/instruction.pdf') }}">{{ asset('pdf/instruction.pdf') }}</a>
</div>
